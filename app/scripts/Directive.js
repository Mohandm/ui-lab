angular.module('uilabApp').directive('jqdatepicker', function () {
    return {
        restrict: 'A',
        require: 'ngModel',
...
}).directive("radioChecked", function () {
    return {
        restrict: "A",
        link: function (scope, elem, attrs) {
...
}).directive("addButton", function (formService) {
    return {
        restrict: 'AE',
        replace: true,
...
}).directive("uploadAttachment", function (formService) {
    return {
        restrict: 'AE',
        //replace:true,
...
}).directive('manualInstruction', function () {
    return {
        link: function (scope, iElement, iAttrs) {
